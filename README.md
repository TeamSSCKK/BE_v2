...
현재 MVP의 Edge Function은 URI 키에 등록된 개발 Origin을 요청 헤더로 전달하며, 실패한 구간은 거리 기반 계산으로 대체합니다. 장기 운영에서는 ODsay 이용 정책을 확인하고 고정 공인 IP가 있는 서버와 서버 플랫폼 키를 사용하는 구성을 권장합니다.
